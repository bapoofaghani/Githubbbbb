...
require_once __DIR__ . "/../../../config.php";
	...
	if(isset($_SESSION['user_id'])){$game->set_cookie('uid', $user_id);}
	...
	*/
    ...
    <script type="text/javascript">
		...
		var MONEY_FORMAT = [0,'.',','];
		var API_URL	= 'http://' + window.location.hostname + ':<?php echo PORT_1; ?>/api/';
...
<body class="body-tag" oncontextmenu1="return false">
    ...
    <div id="main_container" class="main_container">
        ...
        <div id="splash_screen" class="screen">
            <table class="middle">
                <tr>
                    <td><img src="/V3SERFDSX2:12/default/modules/games/crash/assets/logo.png" class="logo"></td>
                </tr>
            </table>
        </div>
        ...
        <div id="lobby_screen" class="screen hidden">
            <div class="top_left_panel">
                <div class="left height_100"><img src="/V3SERFDSX2:12/default/modules/games/crash/assets/placeholder.png" class="profile_photo clickable settings_button" height="100%"></div>
            ...
            <div class="top_right_panel">
                <div class="right margin_r10 height_100"><img src="/V3SERFDSX2:12/default/modules/games/crash/assets/home.png" height="100%" class="clickable home_button"></div>
                <div class="clear"></div>
            </div>
