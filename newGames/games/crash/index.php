<?php 
  define('ROOT_PATH', $_SERVER['DOCUMENT_ROOT']);
	require_once '../../../newGames/api/RestApi/game.php';
  $game = new Game();
  $game->check_login();
  $db = new DB();
  ...
  function numberformat($dig, $sep = ',', $lim = 3){
    ...
    return $str;
		...
		$Sezar_CHIPS	=	"http://{$_SERVER['HTTP_HOST']}/admincp/includes/SezarFunctions/SZR_Udata.php?id=".$_SESSION['user_id'];
		$get_chips	=	'موجودی <span>'.numberformat(file_get_contents($Sezar_CHIPS)).'</span> تومان ';
	...
	*/
	...
	<head>
		...
		<link rel="shortcut icon" href="/newGames/default/modules/games/crash/assets/favicon.png" type="image/x-icon" />
		<link rel="stylesheet" href="/newGames/default/assets/css/reset.css" />
		<link rel="stylesheet" href="/newGames/default/assets/css/rangeslider.css" />
		<link rel="stylesheet" href="/newGames/default/assets/css/sweetalert.css" />
		<link rel="stylesheet" href="/newGames/default/modules/games/crash/css/style.css?000.002" />

    <script type="text/javascript">
        var DEVICE_TYPE	= 'browser';
		var MONEY_FORMAT = [0,'.',','];
		var API_URL	= '/newGames/api/'; 
		var GAME_FOLDER = '/newGames/default/modules/games/crash/';
		var HOME_URL = '/games';
		var MAIN_URL = '/';
    ...
    <script type="text/javascript" src="/newGames/default/assets/js/jquery.js"></script>
    <script type="text/javascript" src="/newGames/default/assets/js/rangeslider.min.js"></script>
    <script type="text/javascript" src="/newGames/default/assets/js/sweetalert.min.js"></script>
    <script type="text/javascript" src="/newGames/default/modules/games/crash/js/game.min.js?v=<?php echo gmdate("YmdHis"); ?>"></script>
...
<body class="body-tag" oncontextmenu1="return false">
    ...
    <div id="main_container" class="main_container">
        ...
        <div id="splash_screen" class="screen">
            <table class="middle">
                <tr>
                    <td><img src="/newGames/default/modules/games/crash/assets/logo.png" class="logo"></td>
                </tr>
            </table>
        </div>
        ...
        <div id="loading_screen" class="screen hidden">
            <table class="middle">
                <tr>
                    <td align="center">
                        <img src="/newGames/default/modules/games/crash/assets/loading.png" class="loading"><br />
                        <center>
        ...
        <div id="disconnect_screen" class="screen hidden">
            <table class="middle">
                <tr>
                    <td>
                        <center>
                            <img src="/newGames/default/modules/games/crash/assets/logo.png" height="100">
        ...
        <div id="lobby_screen" class="screen hidden">
            <div class="top_left_panel">
                <div class="left height_100"><img src="/newGames/default/modules/games/crash/assets/placeholder.png" class="profile_photo clickable settings_button" height="100%"></div>
            ...
            <div class="top_right_panel">
                <div class="right margin_r10 height_100"><img src="/newGames/default/modules/games/crash/assets/home.png" height="100%" class="clickable home_button"></div>
                <div class="clear"></div>
            </div>
                    ...
                    <tr>
                        <td>
                            <center>
                                ...
                                <div class="rules"><a href="/Sezar-Modules/post.php?link=crash-rules" target="_blank" class="lang_60">How to play?</a></div><br><div class="rules-fair"><a href="/Sezar-Modules/post.php?link=crash-fair" class="lang_61" target="_blank">Is this game fair?</a></div>
                            </center>
                        </td>
                    </tr>
                </table>
        ...
        <div id="game_screen" class="screen hidden" style="background: #fff;">
           ...
           <div class="top-bar">
                ...
                <div class="top-link " id="SZRUID"><div id="UCASH"><?= $get_chips ?></div></div>
                <div class="clear"></div>
            </div>
          ...
          <?php } ?>
                ...
                <div class="game-bottom">
                    <div class="tab-container desktop">
                        <a href="javascript:;" class="history-button tab-div-2 tab-active"><div class="tab-inner-div"><span class="lang_67">HISTROY</span></div></a>
						<a href="javascript:;" class="chat-button tab-div-2"><div class="tab-inner-div"><span class="lang_68">CHAT</span></div></a>
                    </div>
                    <div class="tab-container mobile">
                        <a href="javascript:;" class="history-button tab-div-3 tab-active"><div class="tab-inner-div"><span class="lang_67">HISTROY</span></div></a>
                        <a href="javascript:;" class="chat-button tab-div-3"><div class="tab-inner-div"><span class="lang_68">CHAT</span></div></a>
                    ...
                    <div class="chat-panel hidden">
                        ...
                        <div class="chat-text">
                            <form method="post" action="#null" onSubmit="$('.chat-send').click(); return false;">
                                ...
                                <a href="javascript:;" class="chat-send"><img src="/newGames/default/modules/games/crash/assets/send.png?" height="24"></a>
                            </form>
                        </div>
                    </div>
                    <div class="clear"></div>
    ...
    <script>
		...
		setInterval("SZRUID()",1000); 
			function SZRUID(){
			 $('#UCASH span').load('<?php echo $Sezar_CHIPS; ?>');
			}
