		...
		<div class="inline container">
			...
			<div class="left static-content">
				<div class="page-area container inline form-container">
					<div class="page-title">لیست تیکت ها <span class="pull-right"><a style="margin-top: -2px !important;" class="btn btn-sm btn-success" href="{site_url}contacts/tickets/new-ticket">ارسال تیکت جدید</a></span></div>
