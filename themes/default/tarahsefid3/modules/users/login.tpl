    ...
    <div class="container">
        <section class=" col-lg-6 col-lg-offset-3 col-md-6 col-md-offset-3  col-sm-12 col-xs-12 nopadding signupbox">
            ...
            <div class="signupform">
				...
				<div class="row">
					<div class="col-md-8" style="width: max-content;padding-right: 0px !important;">
						<button class="btn btn-lg btn-green floatright" type="submit">ورود به حساب کاربری</button>
					</div>
				  <div class="extra pull-left">
                    <a href="{site_url}users/resetPassword" style="color: white;">کلمه عبور خود را فراموش کرده اید؟</a>
                </div>
				</div>
