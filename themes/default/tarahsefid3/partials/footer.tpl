	...
	<div class="mobile mobile-footer-bar">
		<a href="{site_url}bets/upComing" class="scores {if strpos($smarty.server.REQUEST_URI, "upComing") !== false OR strpos($smarty.server.REQUEST_URI, "preEvents") !== false}active{/if}">پیش بینی ورزشی</a>
